...
- About Translations, the maintainers **MUST**:
  ...
  - Move all required strings for any custom packages for device (XiaomiParts, OnePlus Settings, Doze) in [devicesettings](https://github.com/DroidX-UI/packages_resources_devicesettings) repository.
